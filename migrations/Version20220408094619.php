 ...
 */
final class Version20220408094619 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe ADD presentation LONGTEXT DEFAULT NULL');
    }

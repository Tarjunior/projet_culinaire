 ...
 */
final class Version20220314212421 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD token_password_lost VARCHAR(255) DEFAULT NULL');
    }
